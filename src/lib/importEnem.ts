...
const SUBJECT_KEYWORDS: Record<Subject, string[]> = {
  ...
  'Biologia': [
    ...
    'hereditario', 'hereditariedade', 'mendel', 'dihibridismo',
    ...
    'clorofila', 'ciclo de calvin', 'krebs',
  ...
  'Matemática': [
    ...
    'mmc', 'mdc', 'divisao', 'divisivel', 'primo',
    ...
    'multiplo', 'criterio de divibilidade',
    'notacao cientifica', 'notacao decimal',
    'corpo', 'faces', 'arestas', 'vertices',
    'paralela', 'perpendicular', 'concorrente',
  ...
  'Geografia': [
    ...
    'pib', 'desenvolvimento', 'idh', 'indicadores',
    'desemprego', 'informalidade', 'trabalho escravo',
    'migracao', 'migrante', 'refugiado', 'apatriida',
  ...
  'História': [
    ...
    'abolicao', 'lei aurea', 'princessa', 'abole',
